...
1. **Инкапсуляция** - размещение поведения и свойств объекта внутри него таким образом, чтобы это поведение или свойства были скрыты от внешнего мира.
...
2. **Наследование** - используется для того, чтобы выделить для некоторых подобных классов что-то общее и разместить это в родительский класс
...
3. **Полиморфизм** - свойство ООП, которое позволяет использовать что-то общее для решения разных задач
...
- **Прототипное наследование** - каждый объект может наследовать свойства и методы другого объекта
...
- **Классы** - более удобная оболочка над прототипами;
